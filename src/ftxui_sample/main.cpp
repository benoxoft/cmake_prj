...
// configuration step. It creates a namespace called `cmake_prj`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cmake_prj::cmake::project_name, cmake_prj::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cmake_prj::cmake::project_version);
      return EXIT_SUCCESS;
    }
